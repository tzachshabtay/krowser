...
pub async fn get_connectors() -> Result<Json<dto::GetConnectorsResult>, String> {
    let resp = retry_async("fetching connectors", || reqwest::get(format!("{}/connectors", *config::KAFKA_CONNECT_URL))).await?;
...
pub async fn get_connector_status(connector: &str) -> Result<Json<dto::GetConnectorStatusResult>, String> {
    let resp = retry_async("fetching connector status", || reqwest::get(format!("{}/connectors/{}/status", *config::KAFKA_CONNECT_URL, connector))).await?;
...
pub async fn get_connector_config(connector: &str) -> Result<Json<dto::GetConnectorConfigResult>, String> {
    let resp = retry_async("fetching connector config", || reqwest::get(format!("{}/connectors/{}/config", *config::KAFKA_CONNECT_URL, connector))).await?;
...
pub async fn get_connector_tasks(connector: &str) -> Result<Json<Vec<dto::GetConnectorTasksResult>>, String> {
    let resp = retry_async("fetching connector tasks", || reqwest::get(format!("{}/connectors/{}/tasks", *config::KAFKA_CONNECT_URL, connector))).await?;
...
pub async fn get_connector_task_status(connector: &str, task: &str) -> Result<Json<dto::GetConnectorTaskStatusResult>, String> {
    let resp = retry_async("fetching connector task status", || reqwest::get(format!("{}/connectors/{}/tasks/{}/status", *config::KAFKA_CONNECT_URL, connector, task))).await?;
